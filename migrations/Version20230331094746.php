 ...
 */
final class Version20230331094746 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE etudiant (id INT AUTO_INCREMENT NOT NULL, departement_id INT NOT NULL, ville_id INT NOT NULL, nom VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, INDEX IDX_717E22E3CCF9E01E (departement_id), INDEX IDX_717E22E3A73F0036 (ville_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
